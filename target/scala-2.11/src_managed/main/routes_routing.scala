...
def documentation = List(("""GET""", prefix,"""controllers.Application.index()"""),play.crud.Routes.documentation).foldLeft(List.empty[(String,String,String)]) { (s,e) => e.asInstanceOf[Any] match {
